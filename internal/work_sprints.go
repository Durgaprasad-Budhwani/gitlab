...
func (ge *GitlabExport) exportRepoMilestones(project *sdk.SourceCodeRepo) error {
...
func (ge *GitlabExport) exportProjectsMilestones(repos []*sdk.SourceCodeRepo) error {
...
func (ge *GitlabExport) exportProjectMilestones(project *sdk.SourceCodeRepo) error {
...
func (ge *GitlabExport) exportGroupMilestones(namespace *api.Namespace, repos []*sdk.SourceCodeRepo) error {
